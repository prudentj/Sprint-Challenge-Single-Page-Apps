...
> Answer: Client-side routing allows for the entire webpage to be loaded at once which greatly increases user experience when navagtating a site with many pages, due to less reloading screens.
